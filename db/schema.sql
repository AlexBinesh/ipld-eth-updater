...
--
-- Name: add_state_leaf_key(bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.add_state_leaf_key(height bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: add_storage_leaf_key(bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.add_storage_leaf_key(height bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: collect_removed_state(bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.collect_removed_state(height bigint) RETURNS SETOF eth.state_cids
    LANGUAGE sql
    AS $$
...
--
-- Name: collect_removed_storage(bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.collect_removed_storage(height bigint) RETURNS SETOF eth.storage_cids
    LANGUAGE sql
    AS $$
...
--
-- Name: find_state_leaf_key(bytea, bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.find_state_leaf_key(state_path bytea, height bigint) RETURNS character varying
    LANGUAGE sql
    AS $$
...
--
-- Name: find_storage_leaf_key(bytea, character varying, bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.find_storage_leaf_key(storage_path bytea, state_leaf_key character varying, height bigint) RETURNS character varying
    LANGUAGE sql
    AS $$
